package com.example.chat.friendrequest;
...
public class RequestAdapter extends RecyclerView.Adapter<RequestAdapter.RequestViewHolder> {
    ...
    public RequestAdapter.RequestViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.friendrequests,parent, false);
    ...
    private void handleException(@NotNull RequestViewHolder holder, Exception exception) {
